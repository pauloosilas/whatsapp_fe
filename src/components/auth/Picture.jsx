...
const Picture = ({ readablePicture, setReadablePicture, setPicture }) => {
  ...
  const handlePicture=(e)=> {
    ...
    if(
        ...
        setError(`${pic.name} is too large, maximum 50mb allowed`)
    }else{
        setError("");
        setPicture(pic);
     ...
     <div className="mt-8 content-center dark:text-dark_text_1">
        ...
        {   
            ...
            <div>
                ...
                <div className="mt-2 w-20 py-1 dark:bg-dark_bg_3 text-xs rounded-md font-bold flex items-center justify-center cursor-pointer"
